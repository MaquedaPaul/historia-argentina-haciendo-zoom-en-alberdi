...
- [x] **S09: Origen de unitarios y federales** `risk:medium` `depends:[]`
...
- [x] **S10: Ideas de unitarios y federales** `risk:low` `depends:[S09]`
...
- [x] **S11: Referentes de cada bando** `risk:low` `depends:[S10]`
...
- [x] **S12: La gobernación en un país dividido — caudillos y Buenos Aires** `risk:medium` `depends:[S11]`
...
- [x] **S13: El primer gobierno de Rosas — cómo llegó al poder** `risk:medium` `depends:[S12]`
...
- [x] **S14: El segundo gobierno de Rosas — el Restaurador** `risk:medium` `depends:[S13]`
...
- [x] **S15: El asesinato de Facundo Quiroga — ¿fue Rosas?** `risk:high` `depends:[S14]`
...
- [x] **S16: La represión rosista — ¿perseguía y mataba?** `risk:high` `depends:[S14]`
...
- [x] **S17: ¿Sin Rosas, Argentina sería un caos?** `risk:medium` `depends:[S16]`
...
- [x] **S18: Los unitarios conspiraban** `risk:medium` `depends:[S17]`
...
- [x] **S19: ¿Rosas fue un tirano?** `risk:high` `depends:[S18]`
...
- [x] **S20: Lo del 29 — el fusilamiento de Dorrego y la crisis de 1829** `risk:medium` `depends:[S19]`
...
- [x] **S21: La Suma del Poder Público — ¿avalada por todas las provincias?** `risk:medium` `depends:[S20]`
...
- [x] **S22: ¿Sin Rosas la Patria hubiera caído?** `risk:medium` `depends:[S21]`
...
- [x] **S23: Encarnación Ezcurra — influencia sobre mujeres y apoyo a Rosas** `risk:medium` `depends:[S22]`
...
- [x] **S24: Encarnación Ezcurra antes de Rosas — ¿era conocida?** `risk:high` `depends:[S23]`
