...
- [x] **S01: Infancia, familia y años formativos (1810–1824)** `risk:high` `depends:[]`
...
- [x] **S02: De Tucumán a Buenos Aires — primeros pasos (1824–1833)** `risk:high` `depends:[S01]`
...
- [x] **S03: Regreso a Tucumán, Alejandro Heredia y vuelta a Buenos Aires (1833–1838)** `risk:medium` `depends:[S02]`
...
- [x] **S04: Alberdi multifacético — periodista, abogado, economista, músico** `risk:low` `depends:[S03]`
...
- [x] **S05: El encuentro entre Alberdi y Facundo Quiroga — la carta** `risk:high` `depends:[S04]`
...
- [x] **S06: Quién era Facundo Quiroga y con quién estaba cuando recibió la carta** `risk:high` `depends:[S05]`
...
- [x] **S07: Por qué Alberdi rechazó el viaje a EE.UU. financiado por Quiroga** `risk:medium` `depends:[S06]`
...
- [x] **S08: Los escritos de Alberdi que leyó Facundo Quiroga** `risk:medium` `depends:[S07]`
