...
## Estado actual
M001–M014 completados. M015–M019 planificados (episodios narrativos nuevos: Generación del 37, Alberdi-Mitre, perfil de Urquiza, camino a Caseros, ruptura Mitre-Urquiza 1852). M014 agregó sección `#rev-tertulias-mariquita` con 6 cards (TER-1 a TER-6) sobre las tertulias de Mariquita Sánchez de Thompson — el Himno Nacional tratado como rumor/tradición oral con nota historiográfica visible. Sitio live en producción en GitHub Pages con lightbox modal (M013) + accordion expand/collapse (M012) + todos los contenidos M001–M014.
...
## Key Files
- `index.html` — Estructura HTML completa: sección colonial (7 cards, colonial-timeline), sección revolución (20 cards en 4 sub-períodos + 6 cards tertulias de Mariquita, sub-nav con 8 links, revolucion-timeline 1800-1860, expand/collapse en 4 cards), sección nacional (7 cards, nacional-timeline 1860-1900, alberdi-quote cierre), footer con epígrafe. Total 125 reveal elements. data-certeza count: 99.
